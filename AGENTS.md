...
&gt; Source: [vercel-labs/web-interface-guidelines](https://github.com/vercel-labs/web-interface-guidelines). Applies to the UI in `app/` and `components/`.  
  
Concise rules for building accessible, fast, delightful UIs. Use MUST/SHOULD/NEVER to guide decisions.  
  
- MUST: All user-facing copy is Korean (labels, placeholders, errors, empty states, `aria-label`). Code identifiers, `slug`, and technical tokens stay English.  
